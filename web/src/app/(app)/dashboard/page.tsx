      ...
      <Shell>
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-[#596b63] text-sm">Acompanhe seu patrimônio e explore o mercado fictício.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-xl p-6 border">
              <div className="text-xs text-[#596b63]">Saldo disponível</div>
              <div className="text-2xl font-bold">{portfolio ? formatMoney(portfolio.balance) : "—"}</div>
            </div>
            <div className="bg-white rounded-xl p-6 border">
              <div className="text-xs text-[#596b63]">Valor das ações</div>
              <div className="text-2xl font-bold">{portfolio ? formatMoney(portfolio.totalCurrentValue) : "—"}</div>
              <div className="text-xs text-[#596b63]">{portfolio?.items.length ?? 0} empresas</div>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-4">
            <div className="bg-white rounded-xl p-6 border">
              <h3 className="font-semibold">Evolução do patrimônio</h3>
              <p className="text-xs text-[#596b63]">Últimos 7 dias · M$</p>
          ...
          <div className="bg-white rounded-xl p-6 border flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-sm text-[#596b63]">Descubra empresas e encontre sua próxima ação.</p>
            </div>
